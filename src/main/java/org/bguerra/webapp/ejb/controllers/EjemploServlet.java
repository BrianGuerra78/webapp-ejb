package org.bguerra.webapp.ejb.controllers;
...
import org.bguerra.webapp.ejb.service.ServiceEjb;
import org.bguerra.webapp.ejb.service.ServiceEjbLocal;
...
public class EjemploServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            service = (ServiceEjbLocal) ctx.lookup("java:global/webapp-ejb/ServiceEjb!org.bguerra.webapp.ejb.service.ServiceEjbLocal");
            service2 = (ServiceEjbLocal) ctx.lookup("java:global/webapp-ejb/ServiceEjb!org.bguerra.webapp.ejb.service.ServiceEjbLocal");
